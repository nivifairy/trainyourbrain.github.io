...
//list of words
const words = ["awedde", "bok", "chickie", "droning", "enough", "fairy", "grace","hir","ice","jerkweed","kvell",
"LOL","micro","nice","oat milk","pronoid","quilling","rat tamer","shero","topophilia","unfathom","vast","WIP","XO","yourself","zoodle"];
//init word
let randomWord;
let score = 0;
let time = 10;
